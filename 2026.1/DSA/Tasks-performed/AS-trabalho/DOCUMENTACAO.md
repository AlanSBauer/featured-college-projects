...
- [ ] S5 - Tabuleiro criado
- [ ] S6 - Carta de Sorte/Reves
- [ ] S7 - Prisao: entrada na fila
- [ ] S8 - Prisao: tentativa de saida
- [ ] S9 - Historico de rodadas
- [ ] S10 - Habilidade passiva ativa
- [ ] S11 - Passagem pelo Inicio
- [ ] S12 - Retrocesso passando pelo Inicio
- [ ] S13 - Compra de propriedade
- [ ] S14 - Pagamento de aluguel
- [ ] S15 - Leilao
- [ ] S16 - Falencia
- [ ] S17 - Encerramento e relatorio final

## Como gerar rapidamente as telas

Execute o projeto e use o menu principal:

- `1 - Gerenciar jogadores` para S1 e S2.
- `2 - Gerenciar imoveis` para S3 e S4.
- `3 - Exibir tabuleiro` para S5.
- `5 - Iniciar partida` para jogar uma partida real e capturar S6 ate S17 conforme os eventos acontecerem.
- `6 - Exibir historico de rodadas` para conferir S9 quando necessario.

Durante a partida, cada turno permite lancar dados, consultar jogadores, consultar historico, consultar tabuleiro ou encerrar a partida. Para cada screenshot, deixe o terminal inteiro visivel e capture a tela junto com a legenda correspondente nesta documentacao.
